...
### Course webpage
[RNA-seq DE analysis](https://github.com/liu3zhenlab/teaching/tree/master/RNA-Seq-Workshop/2022)
...
```{r, eval = T, error=FALSE, message=FALSE, warning=FALSE}
...
if (!require("goseq", quietly=T))
  BiocManager::install("goseq") # GOSeq

if (!require("GO.db", quietly=T))
  BiocManager::install("GO.db", force=T) # GO.db
```
...
[codes](https://raw.githubusercontent.com/liu3zhenlab/teaching/master/RNA-Seq-Workshop/2022/utils/load.R)
...
kable(head(grc, 1))  # show the first 1 rows
kable(tail(grc, 1))  # show the last 1 rows
```
...
<div align="center">
<img src="https://raw.githubusercontent.com/liu3zhenlab/teaching/master/RNA-Seq-Workshop/2022/images/pca.slide.png" width=750 height=400>
</div>
