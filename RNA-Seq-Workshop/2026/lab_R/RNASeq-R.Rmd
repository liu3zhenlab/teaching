...
***
<div align="center">
<img src="https://raw.githubusercontent.com/liu3zhenlab/teaching/master/RNA-Seq-Workshop/2026/images/Rpopularity.png" width=300 height=400>
</div>
...
ts="https://raw.githubusercontent.com/liu3zhenlab/teaching/master/RNA-Seq-Workshop/2026/lab_DE/utils/xcard.R"
source(ts)
```
...
trend="https://raw.githubusercontent.com/liu3zhenlab/teaching/master/RNA-Seq-Workshop/2026/lab_DE/utils/trend.R"
source(trend)
```
...
<div align="center">
<img src="https://raw.githubusercontent.com/liu3zhenlab/teaching/master/RNA-Seq-Workshop/2026/images/install_rstudio_add.png" width=500 height=425>
</div>
...
<div align="center">
<img src="https://raw.githubusercontent.com/liu3zhenlab/teaching/master/RNA-Seq-Workshop/2026/images/Rstudio.png" width=600 height=400>
</div>
- Executing commands
...
dir.create("~/rnaseq") # create a directory for this practice.
setwd("~/rnaseq") # setup working directory.
```
...
- Making data frames
```{r, comment=""}
df <- data.frame(name=c("Josh", "rose"),
                 age=c(23, 35))
df
```
...
```{r, comment=""}
cpm="https://raw.githubusercontent.com/liu3zhenlab/teaching/master/RNA-Seq-Workshop/2026/lab_DE/data/cs.txt"
d <- read.delim(cpm)
head(d, 3)
```
<div align="center">
<img src="https://raw.githubusercontent.com/liu3zhenlab/teaching/master/RNA-Seq-Workshop/2026/images/cost.png" width=320 height=200>
</div>
...
<div align="center">
<img src="https://raw.githubusercontent.com/liu3zhenlab/teaching/master/RNA-Seq-Workshop/2026/images/plot.png" width=500 height=450>
</div>
...
```{r, echo=T}
if (!exists("state.x77")) {
  state.x77 <- read.delim("https://raw.githubusercontent.com/liu3zhenlab/teaching/refs/heads/master/RNA-Seq-Workshop/2026/lab_DE/data/statex77.txt", stringsAsFactors = F)
}
```
