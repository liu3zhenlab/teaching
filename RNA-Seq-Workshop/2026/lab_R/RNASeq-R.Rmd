...
```
<div align="center">
<img src="https://raw.githubusercontent.com/liu3zhenlab/teaching/master/RNA-Seq-Workshop/2022/images/cost.png" width=320 height=200>
</div>
...
### Scatter plot
```{r, echo=F}
write.table(state.x77, "statex77.txt", quote=F, row.names=F, sep="\t")
```
